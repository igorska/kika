...
1. Click **Pay** → redirected to `/success` ✓
2. Check **Terminal 2** — you should see `checkout.session.completed` webhook received ✓
3. Check your email inbox — guide PDF attached ✓
4. Check `ADMIN_EMAIL` inbox — purchase notification with buyer details ✓
